                  ...
                  >
                    <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                      <div className="px-5 pt-4 flex items-center justify-between">
                        ...
                        <div className="-mr-2">
                          <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 text-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
  ...
  >
    ...
    <div className="hidden md:absolute md:flex md:items-center md:justify-end md:inset-y-0 md:right-0">
      <span className="inline-flex rounded-md shadow-sm">
        <a
          href="#"
          className="text-sm inline-flex items-center px-4 py-2 border border-transparent font-medium rounded-md text-secondaryDark border border-gray-200 bg-white hover:text-indigo-500"
          style={{ transform: 'scale(1.1)' }}
        >
          Book a demo
        </a>
