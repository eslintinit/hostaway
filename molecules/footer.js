...
import { Support } from 'organisms'

const navigation = {
  features: [
    { name: 'Calendar', href: '#' },
    { name: 'Single inbox', href: '#' },
    { name: 'Automation', href: '#' },
    { name: 'Team management', href: '#' },
  ],
  solutions: [
    { name: 'For growth', href: '#' },
    { name: 'For marketing', href: '#' },
    { name: 'For individuals', href: '#' },
    { name: 'For business', href: '#' },
  ],
  resources: [
    { name: 'Blog', href: '#' },
    { name: 'Our guide to property management', href: '#' },
    ...
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
      ...
      <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
        ...
        <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
          &copy; 2021 Hostaway, Inc. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
